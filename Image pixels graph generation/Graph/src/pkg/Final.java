 ...
 */
public class Final extends ApplicationFrame implements ActionListener {
	 ...
	 *            the frame title.
	 */
	public Final(final String title) {
	...
	private JFreeChart createChart(final XYDataset dataset) {
		final JFreeChart result = ChartFactory.createTimeSeriesChart(
				"Graph dynamic", "Time", "Value", dataset,
				true, true, false);
	...
	public static void main(final String[] args) {
		...
		final Final demo = new Final("Dynamic Line And TimeSeries Chart");
		demo.pack();
